...
<main id="main-content" class="simple-shell">
  <header class="page-intro">
    ...
    <h1><span data-lang="en">Notes in mathematics</span><span data-lang="ja">数学のノート</span></h1>
    <p data-lang="en">Reading notes on algebraic structures, category theory, and their foundations.</p>
    <p data-lang="ja">代数的構造、圏論、そしてその基礎についての学習ノートです。</p>
  </header>
